...
print("Are you ready to step onto this immersive journey into the world of healthcare? Let's begin!\n")
...
class Patient:
    ...
    def ask_history(self):
        questions = [
            "What past health problems or treatments has she had?",
            "Has she used any medications in the past? Any allergies or adverse reactions to medications?",
            "Does anyone in your family have similar emotional problems or other mental health issues?",
            "What is her daily life like, and how is she feeling recently?",
        ]

        emotions = [
            "No significant past health problems or treatments.",
            "She rarely needs medication, except for antipyretics for colds or fevers. No signs of allergic reactions to medications.",
            "No one in the family has had similar emotional problems. However, I sometimes worry that our arguments with her father might affect her.",
            "Recently, she's become more introverted and less interested in activities. She used to enjoy sports, but now she's less interested.",
        ]
...
# PART 3:
import time
print ("\n Now, it is time to learn about some NHS Values and Qualities required to become a doctor")
print("\n NHS values:")
